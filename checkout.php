                ...
                <div class="payment-methods-selector" id="paymentMethodsSelector">
                  ...
                  <div class="payment-method-item" id="methodMobileMoney" data-method="mobile_money" role="button" tabindex="0">
                    ...
                    <div class="momo-badges-row">
                      <span class="momo-chip-badge badge-orange" style="background:#ff7900; color:#fff; font-size:0.75rem; font-weight:700; padding:2px 6px; border-radius:4px;">Orange</span>
                      <span class="momo-chip-badge badge-mtn" style="background:#ffcc00; color:#002f6c; font-size:0.75rem; font-weight:700; padding:2px 6px; border-radius:4px;">MTN</span>
                      <span class="momo-chip-badge badge-wave" style="background:#1dc4ff; color:#fff; font-size:0.75rem; font-weight:700; padding:2px 6px; border-radius:4px;">Wave</span>
                      <span class="momo-chip-badge badge-moov" style="background:#005baa; color:#fff; font-size:0.75rem; font-weight:700; padding:2px 6px; border-radius:4px;">Moov</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="momo-details-box" id="mobileMoneyDetailsBox" style="display:none; background:#ffffff; border:1px solid #e2e8f0; border-radius:18px; padding:1.25rem; margin-bottom:1.25rem;">
                  <div class="form-group">
                    ...
                    <div class="momo-operators-grid" style="display:grid; grid-template-columns:repeat(auto-fit, minmax(110px, 1fr)); gap:0.5rem; margin-bottom:1rem;">
                      <label class="momo-operator-card active" style="display:flex; align-items:center; gap:0.4rem; padding:0.6rem; border:1.5px solid #6366f1; border-radius:10px; cursor:pointer; background:#f5f3ff;">
                      ...
                      <label class="momo-operator-card" style="display:flex; align-items:center; gap:0.4rem; padding:0.6rem; border:1.5px solid #e2e8f0; border-radius:10px; cursor:pointer; background:#fff;">
                  ...
                  <div class="form-group" style="margin-bottom:0;">
                    ...
                    <div style="display:flex; gap:0.5rem;">
                      <select id="momoCountryPrefix" name="momoCountryPrefix" class="form-input" style="max-width:160px;" aria-label="Indicatif pays">
                      ...
                      <input type="tel" id="momoPhone" name="momoPhone" class="form-input" placeholder="67 12 34 56 7" inputmode="tel" style="flex:1;">
                    </div>
